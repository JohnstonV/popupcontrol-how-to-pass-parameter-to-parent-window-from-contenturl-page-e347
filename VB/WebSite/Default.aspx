...
<%@ Page Language="vb" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="PassParamToContentUrlPage" %>
...
<body>
	<form id="form1" runat="server">
		...
		<dxpc:aspxpopupcontrol id="ASPxPopupControl1" runat="server" clientinstancename="ASPxPopupControl1"
			closeaction="CloseButton" contenturl="~/ASPxperience/PopupControl/PassParamToContentUrlPage/ContentUrlPage.aspx" height="183px"
